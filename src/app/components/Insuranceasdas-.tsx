...
export default function Insurance() {
  ...
  const {
    ...
    initialValues: {
      insuranceCarrier: insuranceData ? insuranceData.insuranceCarrier : '',
      subscriberId: insuranceData ? insuranceData.subscriberId : '',
      hasInsurance: insuranceData ? insuranceData.hasInsurance : '',

      insuranceFirstName: insuranceData ? insuranceData.insuranceFirstName : '',
      insuranceLastName: insuranceData ? insuranceData.insuranceLastName : '',
      insuranceDob: insuranceData ? insuranceData.insuranceDob : '',
      insurancePhone: insuranceData ? insuranceData.insurancePhone : '',
      insuranceCountry: insuranceData ? insuranceData.insuranceCountry : '',
      insuranceAddress: insuranceData ? insuranceData.insuranceAddress : '',
      insuranceAddress2_: insuranceData ? insuranceData.insuranceAddress2_ : '',
      insuranceCity: insuranceData ? insuranceData.insuranceCity : '',
      insuranceState: insuranceData ? insuranceData.insuranceState : '',
      insuranceZip: insuranceData ? insuranceData.insuranceZip : '',
      isValidInsurance: insuranceData ? insuranceData.isValidInsurance : '',
      insuranceSubscriber: insuranceData ? insuranceData.insuranceSubscriber : '',
      subscriberDob: insuranceData ? insuranceData.subscriberDob : '',
      frontInsuranceCard: insuranceData ? insuranceData.frontInsuranceCard : '',
      backInsuranceCard: insuranceData ? insuranceData.backInsuranceCard : '',

      // Additional Insurance Fields
      insuranceCarrier2: insuranceData ? insuranceData.insuranceCarrier2 : '',
      subscriberId2: insuranceData ? insuranceData.subscriberId2 : '',
      hasInsurance2: insuranceData ? insuranceData.hasInsurance2 : '',
      insuranceFirstName2: insuranceData ? insuranceData.insuranceFirstName2 : '',
      insuranceLastName2: insuranceData ? insuranceData.insuranceLastName2 : '',
      insuranceDob2: insuranceData ? insuranceData.insuranceDob2 : '',
      insurancePhone2: insuranceData ? insuranceData.insurancePhone2 : '',
      insuranceCountry2: insuranceData ? insuranceData.insuranceCountry2 : '',
      insuranceAddress2_2: insuranceData ? insuranceData.insuranceAddress2_2 : '',
      insuranceCity2: insuranceData ? insuranceData.insuranceCity2 : '',
      insuranceState2: insuranceData ? insuranceData.insuranceState2 : '',
      insuranceZip2: insuranceData ? insuranceData.insuranceZip2 : '',
      isValidInsurance2: insuranceData ? insuranceData.isValidInsurance2 : '',
      insuranceSubscriber2: insuranceData ? insuranceData.insuranceSubscriber2 : '',
      subscriberDob2: insuranceData ? insuranceData.subscriberDob2 : '',
      frontInsuranceCard2: insuranceData ? insuranceData.frontInsuranceCard2 : '',
      backInsuranceCard2: insuranceData ? insuranceData.backInsuranceCard2 : '',
    },
