...
export default function Confirmation() {
    ...
    const { mercyApplicableRegions } = useEnvVariables();
    console.log(mercyApplicableRegions, "mercy")
    
    const applicableRegionIds = mercyApplicableRegions
    ? mercyApplicableRegions.split(',').map((id:any) => parseInt(id, 10)) 
    : []; 
    const isApplicableRegion = applicableRegionIds.includes(patientData.regionId);
    console.log(patientData.regionId, "patientData.regionId", isApplicableRegion, "isApplicableRegion")
